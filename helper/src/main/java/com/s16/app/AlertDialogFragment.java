...
public class AlertDialogFragment extends DialogFragment implements DialogInterface.OnShowListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mButtonHandler = new ButtonHandler(dialog);
    }
    ...
    public void onShow(final DialogInterface dialog) {
        ...
        if (P.mPositiveButtonListener != null) {
            alertDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mButtonHandler.obtainMessage(AlertDialog.BUTTON_POSITIVE, P.mPositiveButtonListener).sendToTarget();
                }
            });
        }
        if (P.mNeutralButtonListener != null) {
            alertDialog.getButton(AlertDialog.BUTTON_NEUTRAL).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mButtonHandler.obtainMessage(AlertDialog.BUTTON_NEUTRAL, P.mNeutralButtonListener).sendToTarget();
                }
            });
        }
        if (P.mNegativeButtonListener != null) {
            alertDialog.getButton(AlertDialog.BUTTON_NEGATIVE).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mButtonHandler.obtainMessage(AlertDialog.BUTTON_NEGATIVE, P.mNegativeButtonListener).sendToTarget();
                }
            });
        }
    }
    ...
    public String getCursorId(){
        String id = P.mCursor.getString(P.mCursor.getColumnIndex("_id"));
        return id;
    }

    public String getCursorName(String columnName){
        String name = P.mCursor.getString(P.mCursor.getColumnIndex(columnName));
        return name;
    }
