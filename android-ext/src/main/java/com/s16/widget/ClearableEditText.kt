...
class ClearableEditText : AppCompatEditText, View.OnTouchListener, View.OnFocusChangeListener {
    ...
    private val compoundDrawablesCompact : Array<out Drawable?>
    ...
    private val displayedDrawable: Drawable?
        get() = if (this.loc != null) compoundDrawablesCompact[loc!!.idx] else null
    ...
    private fun initIcon() {
        compoundDrawablesCompact.forEach {
            if (it != null) DrawableCompat.setTint(it, currentTextColor)
        }

        this.xD = null
        if (this.loc != null) {
            this.xD = compoundDrawablesCompact[loc!!.idx]
        }
        if (this.xD == null) {
    ...
    private fun setCompoundDrawablesCompact(left: Drawable?, top: Drawable?, right: Drawable?, bottom: Drawable?) {
